...
uint32_t ssp_add_job(ssp_busnr_t busNr, ssp_chip_t chip, uint8_t *array_to_send, uint16_t bytes_to_send, uint8_t *array_to_store, uint16_t bytes_to_read, uint8_t **job_status);
